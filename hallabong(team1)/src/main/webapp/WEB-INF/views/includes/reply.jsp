...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<!-- panel-body의 끝 -->
			<div class="panel-footer" id="footer_pagination"></div>
...
<!-- 리뷰 등록 수정 삭제를 위한 모달 창 만들기 : 맨 처음에는 안보이게 한다. -->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label>리뷰</label>
					<textarea style="resize: none" rows="3" name="reply" class="form-control" id="modalReply"></textarea>
				</div>
				<div class="form-group">
					<label>작성자</label>
					<input name="id" class="form-control" id="modalId" value="${login.id }" data-id="${login.id}" readonly="readonly">
					<input name="loginId" type="hidden" id="loginId" value="${login.id }">
				</div>
			</div>
