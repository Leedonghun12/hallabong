...
<body>
	<div class="container">
		...
		<form class="form-inline">
			...
			<div class="input-group">
				<input type="text" class="form-control" placeholder="Search" name="word" id="word" value="${pageObject.word }">
				...
				<div class="col-md-3">
					<div class="thumbnail dataRow" data-no="${vo.no }">
						...
						<div class="caption">
							...
							<div class="regionKind">
								<p>${vo.region }-${vo.kind }</p>
							</div>
							<div class="introduce">
								<p>${vo.introduce }</p>
							</div>
							...
							<div>
								<p>
									<span class="glyphicon glyphicon-eye-open" style="padding-right: 5px;"></span> ${vo.hit}
								</p>
							</div>
							<div>
								<p>
									<span class="glyphicon glyphicon-pencil" style="padding-right: 5px;"></span> ${vo.replyCnt}
								</p>
							</div>
						</div>
					</div>
