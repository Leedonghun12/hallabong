		...
		$("#listBtn").click(
				function() {
					location = "list.do?page=" + "${param.page}"
							+ "&perPageNum=" + "${param.perPageNum}" + "&key="
							+ "${param.key}" + "&word=" + "${param.word}";
				});
	});
</script>
</head>
	...
	<div class="container">
		...
		<div class="container">
			...
			<p style="text-align: center;">
				<img class="image" src="${vo.image }" alt="${vo.name }">
			</p>
			<h4></h4>
		...
		<h2>${vo.name }</h2>
		<p>
			<span class="glyphicon glyphicon-eye-open" style="padding-right: 10px;"></span> ${vo.hit }
		</p>
		<p>
			<span class="glyphicon glyphicon-pencil" style="padding-right: 10px;"></span> ${vo.replyCnt }
		</p>
