...
<div class="max-width-container">
    ...
    <div class="scroller" style="width: 900px; transition-timing-function: cubic-bezier(0.1, 0.54, 0.4, 1); transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
        <div class="depth3-list">
          ...
          <a href="/faq/list.do" data-match-path="" style="font-size: 20px; padding: 3px 3px 3px 3px;"><strong>FAQ</strong></a>
          </span>
          <span class="depth3-list-items">
          <a href="/qna/list.do" data-match-path="" style="font-size: 20px; padding: 3px 3px 3px 3px;"><strong>QNA</strong></a>
          </span>
      </div>
    </div>
...
<table class="table">
			<tr>
			<th style="font-size: 14px; background-color: #eee">번호</th>
			<th style="font-size: 14px; background-color: #eee">제목</th>
			<th style="font-size: 14px; background-color: #eee">아이디</th>
			<th style="font-size: 14px; background-color: #eee">작성일</th>
			</tr>
