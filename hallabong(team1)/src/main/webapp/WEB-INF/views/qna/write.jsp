...
<div class="container">
	...
	<form method="post">
		...
		<div class="form-group">
			...
			<input name="title" required="required" class="form-control title" style="font-size: 14px;">
		</div>
		<div class="form-group">
			<label style="font-size: 14px;">내용</label>
			<p style="white-space: pre-line;" class="content"><textarea rows="5" name="content" class="form-control content" style="font-size: 14px;"></textarea></p>
		</div>
