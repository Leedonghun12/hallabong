...
<body>
	...
	<h2>객실 수정 </h2>
		...
		<form action="update.do" method="post" enctype="multipart/form-data">
			...
			<tr>
					<th>객실명</th>
					<td><input name="ro_name" class="form-control" value="${vo.ro_name}" ></td>
				</tr>
				<tr>
					<th>1박기준가격</th>
					<td><input name="ro_price" class="form-control" value="${vo.ro_price}"></td>
				</tr>
				<tr>
					<th>인원</th>
					<td><input name="ro_people" class="form-control" value="${vo.ro_people}"></td>
				</tr>
				<tr>
					<th>객실 기본 옵션</th>
					<td><textarea rows="7" name="ro_info" class="form-control" value="${vo.ro_info}"></textarea></td>
				</tr>
				<tr>
					<th>이미지</th>
