	...
	replyService.getList(
			...
			function(pageObject, list){
				...
				*/
				...
				replyUL.html(str); // 원래 있던 것은 사라지고 덮어https://ofcourse.kr/html-course/li-%ED%83%9C%EA%B7%B8 쓰기가 된다.
