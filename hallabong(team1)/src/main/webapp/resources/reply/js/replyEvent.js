...
//			$("myModal").data("star", star);
	...
	});// 리뷰 등록을 위한 모달 창을 보이게 하는 버튼 이벤트 끝

	// 모달 창의 등록 버튼 이벤트 -> 리뷰 등록 처리 진행 -----------------------------------
...
//		console.log(starValue);		
		// 리뷰 등록 함수로 데이터 전달이 잘해서 리뷰 등록 진행
		replyService.add(
			reply,
