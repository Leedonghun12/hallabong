							 ...
							 <div class="col-lg-5">
 									<div class="bg-white p-4">
						               <div class="d-flex mb-2">
						                   <h2 class="mb-3">${vo.ro_no } </h2>
						                   <h2 class="mb-3"></h2>
						                   <h4 class="mb-4">${vo.ro_name}</h4>
						               </div>
						              <table class="table table-borderless">
									      <tr>
									        <th>인원</th>
									        <td>${vo.ro_people }명</td>
									      </tr>
									      <tr>
									        <th>금액</th>
									        <td>${vo.ro_price }</td>
							...
							<div class="row">
								...
								<div class="col-md-12">
										<div class="form-group">
											...
											<input name="checkin" value="${param.checkin }" readonly="readonly"
												class="form-control" id="checkin" />
										</div>
										<div class="form-group">
											<label for="checkout">퇴실날자</label> 
											<input name="checkout" value="${param.checkout}" readonly="readonly"
