...
<body>
<div class="container">
<h1 style="font-size: 20px;">QNA 글 답변하기</h1>
	<form method="post">
		<input name="page" value="${param.page }" type="hidden">
		<input name="perPageNum" value="${param.perPageNum }" type="hidden">
		<input name="no" value="${oneVO.no }" type="hidden">
		...
		<div class="form-group">
			...
			<input name="title" required="required" class="form-control title" value="[답변]${oneVO.title }" style="font-size: 14px;">
		</div>
		<div class="form-group">
			<label style="font-size: 14px;">내용</label>
			<p style="white-space: pre-line;" class="content"><textarea rows="5" name="content" class="form-control content" style="font-size: 14px;">
